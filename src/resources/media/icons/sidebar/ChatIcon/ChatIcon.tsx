...
const ChatIcon: FC<Props> = ({ active }: Props) => {
    return (
        <div>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask1" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="2" width="21" height="20">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                ...
                <g mask="url(#mask1)" fill="url(#paint1_linear)">
                    <rect width="24" height="24" />
                </g>
                <defs>
                    <linearGradient id="paint1_linear" x1="6" y1="4" x2="18" y2="19.5" gradientUnits="userSpaceOnUse">
                        <stop
